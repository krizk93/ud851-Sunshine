...
//      COMPLETED (8) Display the summary that you created above
        ...
        String descrition = SunshineWeatherUtils.getStringForWeatherCondition(mContext,weatherId);

        double highInCelsius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MAX_TEMP);
        double lowInCelsius = mCursor.getDouble(MainActivity.INDEX_WEATHER_MIN_TEMP);
        String highAndLow = SunshineWeatherUtils.formatHighLows(mContext,highInCelsius,lowInCelsius);

        String sWeatherSummary = date + "-" + descrition + "-" + highAndLow;
        forecastAdapterViewHolder.weatherSummary.setText(sWeatherSummary);
    }
