...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (3) Create an array of Strings that contain fake weather data
            String[] weatherData = {"Monday: sunny", "Tuesday: rain", "Wednesday: fog", "Thursday: heavy snow", "Friday: wind", "Saturday: cloudy", "Sunday: hail"};
        // COMPLETED (4) Append each String from the fake weather data array to the TextView
        for (int i=0; i< weatherData.length; i++){
            WeatherDisplay.append(weatherData[i] + "\n\n\n");
        }
    }
}