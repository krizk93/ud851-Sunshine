...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]>{
    ...
    private static final int SUNSHINE_WEATHER_LOADER = 12;
    ...
    private void loadWeatherData() {
        ...
        Bundle locatioBundle = new Bundle();
        locatioBundle.putString(SEARCH_QUERY_LOCATION,location);


        LoaderManager loaderManager = getSupportLoaderManager();
        Loader<String> weatherLoader = loaderManager.getLoader(SUNSHINE_WEATHER_LOADER);
        if (weatherLoader == null){
            loaderManager.initLoader(SUNSHINE_WEATHER_LOADER,locatioBundle,this);
        }else{
            loaderManager.restartLoader(SUNSHINE_WEATHER_LOADER,locatioBundle,this);
        }
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
            return new android.support.v4.content.AsyncTaskLoader<String[]>(this) {
                private String[] mWeatherResults = null;
                @Override
                ...
                public void deliverResult(String[] data) {
                    mWeatherResults = data;
                    super.deliverResult(mWeatherResults);
                }
            };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            loadWeatherData();
            getSupportLoaderManager().restartLoader(SUNSHINE_WEATHER_LOADER,null,this);
