...
//      COMPLETED (7) Display the weather icon using mDetailBinding
        ...
        mDetailBinding.primaryWeatherInfo.icon.setImageResource(weatherIconId);
        /****************
         * Weather Date *
         ****************/
        /*
...
//      COMPLETED (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.weatherCondition.setText(description);
        mDetailBinding.primaryWeatherInfo.weatherCondition.setContentDescription(descriptionAlly);

//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryWeatherInfo.icon.setContentDescription(descriptionAlly);
...
//      COMPLETED (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.highTemperature.setContentDescription(highAlly);
...
//      COMPLETED (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryWeatherInfo.lowTemperature.setContentDescription(lowAlly);
...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraWeatherDetails.humidity.setContentDescription(humidityAlly);
...
//      COMPLETED (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraWeatherDetails.wind.setContentDescription(windAlly);
...
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraWeatherDetails.pressure.setContentDescription(pressureAlly);
