...
//  COMPLETED (20) Create a constant int to identify our loader used in DetailActivity
    ...
    public static final int INDEX_WIND_SPEED = 4;
    ...
    private static final int DETAIL_LOADER_ID = 240;
...
//      COMPLETED (35) Initialize the loader for DetailActivity
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String date = SunshineDateUtils.getFriendlyDateString(this,localDate,true);
        mDate.setText(date);

        int weatherId = data.getInt(INDEX_WEATHER_DESCRIPTION);
        ...
        String highInCelsius = SunshineWeatherUtils.formatTemperature(this,highTemp);
        mHighTemp.setText(highInCelsius);

        double lowTemp = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String lowInCelsius= SunshineWeatherUtils.formatTemperature(this,lowTemp);
        mLowTemp.setText(lowInCelsius);
        ...
        mForecastSummary = String.format("%s - %s - %s%s",date,weatherDescription,highInCelsius,lowInCelsius);
    }
