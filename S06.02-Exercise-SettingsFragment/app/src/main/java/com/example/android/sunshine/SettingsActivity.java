...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (2) Create an pref_general resource directory
        // COMPLETED (3) Add a PreferenceScreen with an EditTextPreference and ListPreference within the newly created pref_general resource directory
        ...
        // COMPLETED (5) Override onCreatePreferences and add the preference pref_general file using addPreferencesFromResource
